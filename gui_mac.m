function varargout = gui_mac(varargin)
% GUI_MAC MATLAB code for gui_mac.fig
%      GUI_MAC, by itself, creates a new GUI_MAC or raises the existing
%      singleton*.
%
%      H = GUI_MAC returns the handle to a new GUI_MAC or the handle to
%      the existing singleton*.
%
%      GUI_MAC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_MAC.M with the given input arguments.
%
%      GUI_MAC('Property','Value',...) creates a new GUI_MAC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_mac_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_mac_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @gui_mac_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_mac_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_mac is made visible.
function gui_mac_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_mac (see VARARGIN)

% Choose default command line output for gui_mac
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_mac wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_mac_OutputFcn(hObject, eventdata, handles) 
