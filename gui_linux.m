function varargout = gui_linux(varargin)
% GUI_LINUX MATLAB code for gui_linux.fig
%      GUI_LINUX, by itself, creates a new GUI_LINUX or raises the existing
%      singleton*.
%
%      H = GUI_LINUX returns the handle to a new GUI_LINUX or the handle to
%      the existing singleton*.
%
%      GUI_LINUX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_LINUX.M with the given input arguments.
%
%      GUI_LINUX('Property','Value',...) creates a new GUI_LINUX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_linux_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_linux_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_linux

% Last Modified by GUIDE v2.5 22-Oct-2015 23:08:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_linux_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_linux_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_linux is made visible.
function gui_linux_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_linux (see VARARGIN)

% Choose default command line output for gui_linux
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_linux wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_linux_OutputFcn(hObject, eventdata, handles) 
...
if spectrum==1
    ...
    time=get(handles.edit4,'string');
    col=get(handles.popupmenu4,'string');
...
set(handles.edit3,'string',handles.selected);
guidata(hObject,handles);
